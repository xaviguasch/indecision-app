        ...
        value: function componentDidMount() {
            try {
                ...
                if (options) {
                    ...
                    }); // same as having { options: options }
                }
            } catch (e) {
...
var AddOption = function (_React$Component2) {
    ...
    function AddOption(props) {
        ...
        _this2.formHandleAddOption = _this2.formHandleAddOption.bind(_this2); // NAME CHANGED TO AVOID CONFUSION
        _this2.state = {
            error: undefined
        };
        return _this2;
    ...
    _createClass(AddOption, [{
        key: 'formHandleAddOption',
        value: function formHandleAddOption(e) {
            e.preventDefault();
            ...
            if (!error) {
                // if there's no error we clear the input
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    'form',
                    { onSubmit: this.formHandleAddOption },
