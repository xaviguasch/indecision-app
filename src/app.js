...
class AddOption extends React.Component {
    constructor(props) {
        super(props)
        this.innerHandleAddOption = this.innerHandleAddOption.bind(this)  // NAME CHANGED TO AVOID CONFUSION
        this.state = {
            error: undefined
        }
    }
    innerHandleAddOption(e) {
        e.preventDefault()
    ...
    render() {
        return (
            <div>
                ...
                <form onSubmit={this.innerHandleAddOption}>
